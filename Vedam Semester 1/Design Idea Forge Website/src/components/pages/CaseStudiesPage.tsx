...
const mockCases: CaseCardProps[] = [
  {
    ...
    description: "A B2B SaaS startup needs to grow from 100 to 1000 users in 3 months with only $5k marketing budget.",
    difficulty: "Medium",
    category: "Marketing",
    attempts: 234,
  },
  {
    ...
    description: "An AI tool with great tech but no clear use case. Help find the right market segment.",
    difficulty: "Hard",
    category: "Product",
    attempts: 189,
  },
  ...
  },
  {
    ...
    description: "Break into enterprise market with a product built for SMBs. What's your approach?",
    difficulty: "Hard",
    category: "Growth",
    attempts: 123,
  },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Real challenges inspired by startups and tech leaders. Practice solving business problems and climb the leaderboard.
            </p>
